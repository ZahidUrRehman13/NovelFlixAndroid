...
public class ThrillerAdapter extends RecyclerView.Adapter<ThrillerAdapter.ViewHolder> {
    private Context context;
    private ArrayList<DataModelClass> dataModelClassesArrayList;

    public ThrillerAdapter(Context context, ArrayList<DataModelClass> dataModelClassesArrayList) {
    ...
    @NonNull
    @Override
    public ThrillerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.thriller__item_layout, parent, false);
        return new ThrillerAdapter.ViewHolder(view, context);
    }

    @Override
    public void onBindViewHolder(@NonNull ThrillerAdapter.ViewHolder holder, int position) {
